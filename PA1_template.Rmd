...
plot(vals$interval,vals$steps,type="l", xlab="Time interval", ylab="Average Number of steps", col="maroon")
...
the total number of NA is `r nNA` with percentage of NA corresponding to given data is `r pcNA`%
